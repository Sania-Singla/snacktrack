        ...
        <div className="w-full relative">
            <Listbox value={selectedValue} onChange={handleClick}>
                <ListboxButton
                    ...
                    className={`border border-gray-300 ${className ? className : 'px-2.5 py-2'} overflow-auto w-full flex justify-between items-center gap-4 rounded-md bg-white cursor-pointer`}
                >
