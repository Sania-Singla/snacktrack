...
export default function ContributorCard({ contributor }) {
    ...
    return (
        <motion.div
            ...
            className="relative bg-white/20 backdrop-blur-lg border border-white/40 shadow-md rounded-2xl overflow-hidden p-6 flex flex-col items-center gap-4 w-[300px]"
        >
            {/* Profile Image */}
